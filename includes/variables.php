...
$tsml_feedback_method = get_option('tsml_feedback_method', 'legacy');

//load whether Change Detection to be enabled or disabled (defaults to disabled)
$tsml_change_detect = get_option('tsml_change_detect', 'disabled');
